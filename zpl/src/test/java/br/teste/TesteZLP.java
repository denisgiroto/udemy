...
public class TesteZLP {
	...
	public void testAlfa() {
		String valor = ZPL
			.novaPagina(12, 70)
				.registra(new CampoAlfanumerico(new Posicao(10, 10) , "Denis Giroto").comRotacao("A", "I") )
			.escrever();
	...
	public void testFonteComAlfa() {
		...
		System.out.println(valor);
		Assert.assertEquals(valor, "^XA^LL560^CF0,96^FO80,80^AAI^FDDenis Giroto^FS^XZ");
	}
